...
df = spark.read.csv("/home/sameera/Downloads/Tharik/transformed.csv", header = True, inferSchema = True)


formula = RFormula(
    formula="Is_Customer ~ Link+Title+Is_Fortune_500",
...
with open('test2.pmml','wb') as output:
